<cfinclude template="select/_criaruser.cfm">
...
<cfoutput>
   ...
   <div id="painel_2">
      <p id="text">Criação de Usuário</p>
         <div class="form-style-2">
            <form id="form" name="form" action="criaruser.cfm" method="GET">
               <label for="field2"><span>Matrícula</span>
                  <input type="text" class="input-field" maxlength="100" placeholder="Matrícula" name="ID"/></label>
                <label for="field2"><span>Login</span>
                  <input type="text" class="input-field" maxlength="100" placeholder="Usuário" name="USERNAME"/></label>
                <label for="field2"><span>Nome</span>
                  <input type="text" class="input-field" maxlength="100" placeholder="Nome" name="NOME"/></label>
                <label for="field2"><span>Senha</span>
                  <input type="text" class="input-field" maxlength="100" placeholder="Senha" name="PASSWORD" value="1234"/></label>
...
<cfif usuario.acessos contains "Moderador" OR usuario.acessos contains "Administrador">
   ...
   <select name="NIVEL" class="select-field">
...
<cfif usuario.acessos contains "Moderador" OR usuario.acessos contains "Administrador">
   ...
   <select name="NIVEL2" class="select-field">
...
<button type="submit" value="save" id="button_buscar" style="vertical-align:middle"><span>Confirmar</span></button>
</form>
</div> 
</div>
</div></center>
